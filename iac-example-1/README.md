...
#### Note: Variable values provided in `terraform.tfvars` are not real and are mocked. Please replace the values of the variables as per your project requirement in your local and never commit `terraform.tfvars` file.
...
#### Note: Variable values provided in `workspace-dev.json` are not real and are mocked. Please replace the values of the variables as per your project requirement in your local and never commit `workspace-dev.json` file.
