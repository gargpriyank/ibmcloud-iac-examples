...
address_prefix_cidr            = ["172.25.40.0/24", "172.25.41.0/24"]
enable_custom_subnet           = true
subnet_cidr                    = ["172.25.40.0/26", "172.25.41.0/26"]
...
enable_vpn                     = true
vpn_connection_pre_shared_key  = ["insecuresharedkey", "insecuresharedkey"]
vpn_connection_interval        = [30, 30]
vpn_connection_timeout         = [120, 120]
vpn_connection_admin_state_up  = [true, true]
vpn_connection_action          = ["restart", "restart"]
vpn_peer_cidr                  = ["192.168.0.0/26", "192.168.1.0/26"]
vpn_peer_public_address        = ["52.116.137.73", "52.116.138.73"]