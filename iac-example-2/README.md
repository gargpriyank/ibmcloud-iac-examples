...
This directory contains the terraform code to provision Red Hat OpenShift Classic, IBM Cloudant database, IBM Event Streams (Kafka) and 2 Bare Metal
Servers. This code provides the flexibility to keep IBM Cloudant database (enable_db_service) 
